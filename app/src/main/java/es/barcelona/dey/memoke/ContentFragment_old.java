 ...
 */
public class ContentFragment_old extends Fragment {
    ...
    /*Gurda ficha actual, 1 o 2*/
    int mCurrentTab;

    Pair mCurrentPair;

    private TextView[] mCurrentTextViews = new TextView[2];
    ...
    public void setListenerImgPencil(ImageView image, final boolean isClickinForEdit){
        image.setOnClickListener(new View.OnClickListener() {
                                      ...
                                      public void onClick(View v) {
                                              ...
                                              for (int i = 0; i < parent.getChildCount() - 1; i++) {
                                                  ...
                                                  if (button instanceof Button) {
                                                      if (isClickinForEdit) {
                                                          ...
                                                          if (mCurrentPair.getTabs()[mCurrentTab - 1].getType() == Tab.Type.PHOTO) {
                                          ...
                                          //Si la actual ficha es de texto, hay que poner el texto al cancelar la edicion
                                          if (mCurrentTab!=0 && mCurrentPair.getTabs()[mCurrentTab - 1]!=null) {
                                              if (mCurrentPair.getTabs()[mCurrentTab - 1].getType() == Tab.Type.TEXT) {
                                                    if (mCurrentTextViews[mCurrentTab - 1]!=null){
                                                        //Para eso hay que hacer invisible el frame de botones y hacer visible
                                                        //el de texto
                                                        FrameLayout frameBotones = (FrameLayout)parent.getParent();
                                                        frameBotones.setVisibility(View.GONE);

                                                        LinearLayout linearLayoutParent = (LinearLayout)frameBotones.getParent();
                                                        FrameLayout frameLayoutText = (FrameLayout)linearLayoutParent.getChildAt(2);
                                                        frameLayoutText.setVisibility(View.VISIBLE);

                                                        TextView textView = (TextView)frameLayoutText.getChildAt(0);
                                                        textView = mCurrentTextViews[mCurrentTab - 1];
    ...
    public void genEditButtonFromText(ImageView image){
        image.setOnClickListener(new View.OnClickListener() {
                                     @Override
                                     public void onClick(View v) {
                                        FrameLayout frameTexto = (FrameLayout)v.getParent();
                                        LinearLayout linearLayout = (LinearLayout)frameTexto.getParent();
                                         frameTexto.setVisibility(View.GONE);
                                         //Guardamos el TextView, por si le doy a cancelar
                                         TextView textView = (TextView)frameTexto.getChildAt(0);
                                         mCurrentTextViews[mCurrentTab - 1]=textView;

                                         FrameLayout frameBotones = (FrameLayout)linearLayout.getChildAt(1);
                                         frameBotones.setVisibility(View.VISIBLE);

                                         LinearLayout layoutBotones = (LinearLayout)frameBotones.getChildAt(0);
                                         ImageView imageView = (ImageView)layoutBotones.getChildAt(3);
                                         imageView.setImageResource(R.drawable.ic_action_name2);
                                         imageView.setVisibility(View.VISIBLE);
                                         setListenerImgPencil(imageView, false);
    ...
    public void receivingFromDialog(EditText data){
        ...
        //Borramos imagen que pueda existir
    ...
    public void genPhotoButton(Button button){
        ...
        button.setOnClickListener(new View.OnClickListener() {
                                      ...
                                      public void onClick(View v) {
                                          ...
                                          //Conocer cuál es la Ficha actual
                                          FrameLayout frameLayoutButtons = (FrameLayout)t.getParent();
                                          LinearLayout linearLayoutFicha = (LinearLayout)frameLayoutButtons.getParent();
                                          TextView textViewFicha = (TextView)linearLayoutFicha.getChildAt(0);
                                          if (textViewFicha.getText().toString().indexOf("1") > 0) {
                                              mCurrentTab = 1;
                                          } else {
                                              mCurrentTab = 2;
                                          }
                                          ...
                                          mCurrentPair.getTabs()[mCurrentTab - 1].setType(Tab.Type.PHOTO);
    ...
    private void genTextButton(Button button){
        ...
        button.setOnClickListener(new View.OnClickListener() {
                                      ...
                                      public void onClick(View v) {
                                          ...
                                          //Conocer cuál es la Ficha actual
                                          LinearLayout linearLayoutFicha = (LinearLayout)fHide.getParent();
                                          TextView textViewFicha = (TextView)linearLayoutFicha.getChildAt(0);
                                          if (textViewFicha.getText().toString().indexOf("1") > 0) {
                                              mCurrentTab = 1;
                                          } else {
                                          ...
                                          //Actualizo Ficha
                                          mCurrentPair.getTabs()[mCurrentTab - 1]=new Tab();
                                          mCurrentPair.getTabs()[mCurrentTab - 1].setType(Tab.Type.TEXT);
    ...
    private void fixIconCancelEdit(LinearLayout linearLayout){
        ...
        imageViewPencil.setImageResource(R.drawable.ic_action_name2);

        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(imageViewPencil.getLayoutParams());

        //64 tamanho del icono TODO: Averiguar el tamamho de la img porque cuando no sea 64?
        ...
        setListenerImgPencil(imageViewPencil, false);
    }
    ...
    private void fixIconEdit(LinearLayout linearLayout){
        ...
        setListenerImgPencil(imageView, true);
    }
